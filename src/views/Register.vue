...
const name = ref(''), email = ref(''), password = ref(''), show = ref(false), loading = ref(false), error = ref('')

async function handleRegister() {
  if (!name.value || !email.value || !password.value) { error.value = 'Please fill all fields'; return }
