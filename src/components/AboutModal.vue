...
.avatar-img { width: 90px; height: 90px; border-radius: 50%; object-fit: cover; object-position: center 15%; border: 2px solid var(--accent); box-shadow: 0 0 16px rgba(201,169,110,0.3); flex-shrink: 0; }
